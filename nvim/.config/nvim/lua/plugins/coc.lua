...
u.inoremap("<Tab>", smart_tab, {expr = true})
u.inoremap(
  "<S-Tab>",
  function()
...
u.inoremap("<c-space>", vim.fn["coc#refresh"], {expr = true})

u.nmap("[g", "<Plug>(coc-diagnostic-prev)")
...
u.nnoremap("<C-f>", [[coc#float#has_scroll() ? coc#float#scroll(1) : "<C-F>"]], {nowait = true, expr = true})

u.nnoremap("<C-b>", [[coc#float#has_scroll() ? coc#float#scroll(0) : "<C-B>"]], {nowait = true, expr = true})

u.inoremap("<C-f>", [[coc#float#has_scroll() ? coc#float#scroll(1) : "<Right>"]], {nowait = true, expr = true})

u.inoremap("<C-b>", [[coc#float#has_scroll() ? coc#float#scroll(0) : "<Left>"]], {nowait = true, expr = true})
