...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-abolish', 'vim-easydir', 'vim-eunuch', 'vim-mdx-js', 'vim-sandwich', 'gitsigns.nvim', 'lir.nvim', 'lspkind-nvim', 'vim-commentary', 'nvim-colorizer.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'vim-abolish', 'vim-easydir', 'vim-eunuch', 'vim-mdx-js', 'vim-sandwich', 'gitsigns.nvim', 'lir.nvim', 'lspkind-nvim', 'vim-commentary', 'nvim-colorizer.lua'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
