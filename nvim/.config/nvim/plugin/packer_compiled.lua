...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "nvim-autopairs", "cmp-buffer", "cmp-path", "cmp-nvim-lua" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'lir.nvim', 'lspkind-nvim', 'vim-abolish', 'vim-agriculture', 'vim-commentary', 'vim-easydir', 'vim-markdown', 'nvim-colorizer.lua', 'vim-mdx-js', 'vim-sandwich', 'nvim-ts-context-commentstring', 'vim-eunuch', 'gitsigns.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lir.nvim', 'lspkind-nvim', 'vim-abolish', 'vim-agriculture', 'vim-commentary', 'vim-easydir', 'vim-markdown', 'nvim-colorizer.lua', 'vim-mdx-js', 'vim-sandwich', 'nvim-ts-context-commentstring', 'package-info.nvim', 'vim-eunuch', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
