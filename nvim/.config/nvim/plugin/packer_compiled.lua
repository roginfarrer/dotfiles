...
_G.packer_plugins = {
  ...
  ["nvim-lspconfig"] = {
    config = { "\27LJ\2\n9\0\0\3\1\2\0\a-\0\0\0\15\0\0\0X\1\3€6\0\0\0'\2\1\0B\0\2\1K\0\1\0\1\0\16plugins.lsp\frequire\0" },
    loaded = true,
...
try_loadstring("\27LJ\2\n9\0\0\3\1\2\0\a-\0\0\0\15\0\0\0X\1\3€6\0\0\0'\2\1\0B\0\2\1K\0\1\0\1\0\16plugins.lsp\frequire\0", "config", "nvim-lspconfig")
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-ts-context-commentstring', 'package-info.nvim', 'nvim-colorizer.lua', 'gitsigns.nvim', 'lir.nvim', 'vim-abolish', 'vim-agriculture', 'vim-commentary', 'vim-easydir', 'vim-eunuch', 'vim-markdown', 'vim-mdx-js', 'vim-sandwich'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'nvim-ts-context-commentstring', 'nvim-colorizer.lua', 'gitsigns.nvim', 'lir.nvim', 'vim-abolish', 'vim-agriculture', 'vim-commentary', 'vim-easydir', 'vim-eunuch', 'vim-markdown', 'vim-mdx-js', 'vim-sandwich'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
