...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'nvim-colorizer.lua', 'vim-markdown', 'nvim-ts-context-commentstring', 'package-info.nvim', 'vim-mdx-js'}, { event = "BufRead *" }, _G.packer_plugins)]]
