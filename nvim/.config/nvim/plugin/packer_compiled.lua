...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'package-info.nvim', 'nvim-ts-context-commentstring', 'lir.nvim', 'lspkind-nvim', 'vim-abolish', 'vim-agriculture', 'vim-easydir', 'vim-eunuch', 'vim-markdown', 'vim-mdx-js', 'nvim-colorizer.lua', 'vim-sandwich', 'vim-commentary'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'gitsigns.nvim', 'nvim-ts-context-commentstring', 'lir.nvim', 'lspkind-nvim', 'vim-abolish', 'vim-agriculture', 'vim-easydir', 'vim-eunuch', 'vim-markdown', 'vim-mdx-js', 'nvim-colorizer.lua', 'vim-sandwich', 'vim-commentary'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
