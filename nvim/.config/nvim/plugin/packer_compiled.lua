...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lspkind-nvim', 'nvim-colorizer.lua', 'vim-abolish', 'vim-commentary', 'vim-easydir', 'vim-eunuch', 'vim-mdx-js', 'vim-sandwich', 'gitsigns.nvim', 'lir.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'lspkind-nvim', 'nvim-colorizer.lua', 'vim-abolish', 'vim-commentary', 'vim-easydir', 'vim-eunuch', 'vim-mdx-js', 'vim-sandwich', 'gitsigns.nvim', 'lir.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
