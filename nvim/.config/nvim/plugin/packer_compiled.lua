...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-markdown', 'nvim-colorizer.lua', 'vim-sandwich', 'nvim-ts-context-commentstring', 'lspkind-nvim', 'lir.nvim', 'package-info.nvim', 'gitsigns.nvim', 'vim-mdx-js', 'vim-abolish', 'vim-agriculture', 'vim-commentary', 'vim-eunuch', 'vim-easydir'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'vim-markdown', 'nvim-colorizer.lua', 'vim-sandwich', 'nvim-ts-context-commentstring', 'lspkind-nvim', 'lir.nvim', 'gitsigns.nvim', 'vim-mdx-js', 'vim-abolish', 'vim-agriculture', 'vim-commentary', 'vim-eunuch', 'vim-easydir'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
