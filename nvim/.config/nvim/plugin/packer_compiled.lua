...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-mdx-js', 'nvim-treesitter', 'nvim-ts-context-commentstring', 'nvim-colorizer.lua', 'package-info.nvim', 'vim-markdown'}, { event = "BufRead *" }, _G.packer_plugins)]]
