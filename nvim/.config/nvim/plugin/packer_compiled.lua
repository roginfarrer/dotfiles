...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "nvim-autopairs", "cmp-buffer", "cmp-nvim-lua", "cmp-path" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-abolish', 'vim-agriculture', 'vim-easydir', 'vim-eunuch', 'vim-markdown', 'nvim-colorizer.lua', 'vim-mdx-js', 'nvim-ts-context-commentstring', 'package-info.nvim', 'gitsigns.nvim', 'lir.nvim', 'lspkind-nvim', 'vim-commentary', 'vim-sandwich'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'vim-abolish', 'vim-agriculture', 'vim-easydir', 'vim-eunuch', 'vim-markdown', 'nvim-colorizer.lua', 'vim-mdx-js', 'nvim-ts-context-commentstring', 'gitsigns.nvim', 'lir.nvim', 'lspkind-nvim', 'vim-commentary', 'vim-sandwich'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
