...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lspkind-nvim', 'vim-abolish', 'vim-agriculture', 'vim-commentary', 'vim-mdx-js', 'vim-easydir', 'vim-eunuch', 'nvim-colorizer.lua', 'vim-markdown', 'vim-sandwich', 'nvim-ts-context-commentstring', 'package-info.nvim', 'gitsigns.nvim', 'lir.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'lspkind-nvim', 'vim-abolish', 'vim-agriculture', 'vim-commentary', 'vim-mdx-js', 'vim-easydir', 'vim-eunuch', 'nvim-colorizer.lua', 'vim-markdown', 'vim-sandwich', 'nvim-ts-context-commentstring', 'gitsigns.nvim', 'lir.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
