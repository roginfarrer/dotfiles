...
_G.packer_plugins = {
  ...
  hop = {
    ...
    loaded = true,
    path = "/Users/rfarrer/.local/share/nvim/site/pack/packer/start/hop"
  },
  ["impatient.nvim"] = {
    loaded = true,
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'gitsigns.nvim', 'lir.nvim', 'lspkind-nvim', 'vim-abolish', 'vim-commentary', 'vim-mdx-js', 'vim-sandwich', 'nvim-colorizer.lua', 'vim-easydir', 'vim-eunuch'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'gitsigns.nvim', 'lir.nvim', 'lspkind-nvim', 'vim-abolish', 'vim-commentary', 'vim-mdx-js', 'vim-sandwich', 'nvim-colorizer.lua', 'vim-easydir', 'vim-eunuch'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
