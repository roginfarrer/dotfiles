...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-colorizer.lua', 'vim-markdown', 'vim-mdx-js', 'nvim-ts-context-commentstring', 'package-info.nvim', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
