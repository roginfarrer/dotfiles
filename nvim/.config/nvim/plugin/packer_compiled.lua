...
_G.packer_plugins = {
  ...
  ["nvim-web-devicons"] = {
    config = { "\27LJ\2\nŸ\1\0\0\5\0\b\0\v6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\6\0005\3\4\0005\4\3\0=\4\5\3=\3\a\2B\0\2\1K\0\1\0\roverride\1\0\0\20lir_folder_icon\1\0\0\1\0\3\ticon\bî—¿\tname\18LirFolderNode\ncolor\f#7ebae4\nsetup\22nvim-web-devicons\frequire\0" },
    loaded = true,
...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'vim-abolish', 'lspkind-nvim', 'vim-agriculture', 'vim-commentary', 'vim-easydir', 'vim-eunuch', 'vim-mdx-js', 'vim-sandwich', 'vim-markdown', 'gitsigns.nvim', 'nvim-colorizer.lua', 'lir.nvim', 'nvim-ts-context-commentstring'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'package-info.nvim', 'vim-abolish', 'lspkind-nvim', 'vim-agriculture', 'vim-commentary', 'vim-easydir', 'vim-eunuch', 'vim-mdx-js', 'vim-sandwich', 'vim-markdown', 'gitsigns.nvim', 'nvim-colorizer.lua', 'lir.nvim', 'nvim-ts-context-commentstring'}, { event = "BufRead *" }, _G.packer_plugins)]]
