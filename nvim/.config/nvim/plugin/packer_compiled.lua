...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-colorizer.lua', 'vim-mdx-js', 'nvim-treesitter', 'package-info.nvim', 'vim-markdown', 'nvim-ts-context-commentstring'}, { event = "BufRead *" }, _G.packer_plugins)]]
