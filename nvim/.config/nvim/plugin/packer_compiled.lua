...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-ts-context-commentstring', 'gitsigns.nvim', 'lir.nvim', 'lspkind-nvim', 'vim-abolish', 'vim-agriculture', 'vim-commentary', 'vim-eunuch', 'vim-markdown', 'nvim-colorizer.lua', 'vim-sandwich', 'vim-easydir', 'vim-mdx-js'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'nvim-ts-context-commentstring', 'gitsigns.nvim', 'lir.nvim', 'lspkind-nvim', 'vim-abolish', 'vim-agriculture', 'vim-commentary', 'vim-eunuch', 'vim-markdown', 'nvim-colorizer.lua', 'vim-sandwich', 'vim-easydir', 'vim-mdx-js'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
